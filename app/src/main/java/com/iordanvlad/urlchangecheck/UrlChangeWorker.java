...
public class UrlChangeWorker extends Worker {
    private static final String TAG = "UrlChangeWorker";
    ArrayList<String> url_data_list = new ArrayList<>();
    private NotificationManagerCompat notificationManager;

    public UrlChangeWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public void sendNotification(int position) {
        try {
            ...
            int ut1 = (int)Instant.now().getEpochSecond();
